...
layout: post
published: true
slug: 2025-12-29-how-i-built-my-personal-website
tags:
- technology
- creativity
- ai
...
- Ideate and develop with AI! The barriers to creating a website or doing anything with code are lower than ever with AI. I know, that sounds like some kind of startup tagline. But really, it's pretty sick.
  - Since I "learned" how to vibe code, I've been able to focus purely on the vision, design and "product management" of my website (where I'm "managing" the LLM agent that's doing the coding). Initially, I copied and pasted from the internet, until I caved and started paying $20 for the OpenAI Codex extension that goes straight in my IDE (VS Code). It's proved extremely powerful and capable of debugging the deepest bugs that I've previously been stuck on for months.
  - LLMs can also point you in the right direction early on. The more you tell it, the more helpful it is. These days, you can upload images and the LLM will figure out the rest. This is pretty great -- it means that you can focus on the vision and design.
